...
\begin{multicols}{2}
    ...
    \fontspec[Path = ../fonts/Openfonts/raleway/]{Raleway-Medium}\fontsize{10pt}{8pt}\selectfont \color{primary}Python \textbullet{} C++ \textbullet{} C \textbullet{} SML \textbullet{} Bash\\
    % \ \vspace{0.3em} \\
    ...
    \fontspec[Path = ../fonts/Openfonts/raleway/]{Raleway-Medium}\fontsize{10pt}{8pt}\selectfont \color{primary} Teamwork \textbullet{} Teaching \textbullet{} Communication\\ %\textbullet{} Intermediate in French \textbullet{} Beginner in Chinese \textbullet{} Beginner in Japanese
\end{multicols}
